            ...
            if (container.parentElement.id === "chart1") {
                ...
                setTimeout(function() {
                    if (mousey + $('.nvtooltip').height()+100 > windowHeight) {
                        if($('.nvtooltip').height()>windowHeight){$('.nvtooltip').css({'zoom':'0.8','-moz-transform:':'scale(0.8)'})}
...
// http://bl.ocks.org/jasondavies/1341281
    ...
    nv.models.scatterChart = function() {
        ...
        chart._options = Object.create({}, {
            ...
            tooltipXContent: {get: function() {
                    return tooltipX;
                }, set: function(_) {
                    tooltipX = _;
                }},
            tooltipYContent: {get: function() {
                    return tooltipY;
                }, set: function(_) {
                    tooltipY = _;
                }},
